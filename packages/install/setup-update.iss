...
; SEE THE DOCUMENTATION FO1 DETAILS ON CREATING INNO SETUP SCRIPT FILES!
...
Source: {#Workspace}\build\doc\canary\CANARY-UM.pdf; DestDir: {userdocs}\My CANARY; Flags: promptifolder overwritereadonly
Source: {#Workspace}\build\doc\canary\CANARY-UM.pdf; DestDir: {app}\doc; Flags: promptifolder overwritereadonly
...
Name: {app}\canary.exe; Type: files
[Registry]
...
Root: HKCU; Subkey: Software\Classes\yamlfile; ValueType: string; ValueData: YAML File; Flags: createvalueifdoesntexist 
Root: HKCU; Subkey: Software\Classes\yamlfile\Shell\Run; ValueType: string; ValueData: &Run CANARY; Flags: createvalueifdoesntexist uninsdeletekey
Root: HKCU; Subkey: Software\Classes\yamlfile\Shell\Run\command; ValueType: string; ValueData: """{app}\bin\canary.exe"" ""%1"""; Flags: createvalueifdoesntexist uninsdeletekey
Root: HKCU; Subkey: Software\Classes\yamlfile\Shell\Open; ValueType: string; ValueData: &Edit; Flags: createvalueifdoesntexist
Root: HKCU; Subkey: Software\Classes\yamlfile\Shell\Open\command; ValueType: string; ValueData: """notepad.exe"" ""%1"""; Flags: createvalueifdoesntexist
Root: HKCR; Subkey: .yml; ValueType: string; ValueData: yamlfile; Flags: createvalueifdoesntexist uninsdeletekey
Root: HKCR; Subkey: yamlfile; ValueType: string; ValueData: CANARY Configuration File; Flags: createvalueifdoesntexist uninsdeletekey
Root: HKCR; Subkey: yamlfile\Shell\Run; ValueType: string; ValueData: &Run CANARY; Flags: createvalueifdoesntexist uninsdeletekey
Root: HKCR; Subkey: yamlfile\Shell\Run\command; ValueType: string; ValueData: """{app}\bin\canary.exe"" ""%1"""; Flags: createvalueifdoesntexist uninsdeletekey
Root: HKCR; Subkey: yamlfile\Shell\Open; ValueType: string; ValueData: &Edit; Flags: createvalueifdoesntexist 
Root: HKCR; Subkey: yamlfile\Shell\Open\command; ValueType: string; ValueData: """notepad.exe"" ""%1"""; Flags: createvalueifdoesntexist 
[Icons]
